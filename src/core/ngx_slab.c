...
void ngx_slab_sizes_init(void)
{
    ...
    ngx_slab_max_size = ngx_pagesize / 2; /*@TODO:变量ngx_slab_max_size = 2048 */
    ngx_slab_exact_size = ngx_pagesize / (8 * sizeof(uintptr_t)); /*@TODP:ngx_slab_exact_size = (4096/32) = 128 */
    for (n = ngx_slab_exact_size; n >>= 1; ngx_slab_exact_shift++) {
        /* void */
    }
	/*@TODO:ngx_slab_exact_shift = 7*/
}
